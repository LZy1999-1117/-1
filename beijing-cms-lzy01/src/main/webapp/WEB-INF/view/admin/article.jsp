            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">
                  	<font size="20px"><a class="card-footer text-white clearfix small z-1" href="/admin/specialAll">文章管理</a></font>
                  </div>
                </div>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-warning o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">
                  	<font size="20px"><a class="card-footer text-white clearfix small z-1" href="/admin/specialAll">垃圾管理</a></font>
                  </div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="#">
                  <span class="float-left">View Details</span>
